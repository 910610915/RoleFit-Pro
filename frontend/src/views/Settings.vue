  ...
  <div class="settings">
    ...
    <n-tabs type="line">
        ...
        <n-card title="常规设置">
          <n-form label-placement="left">
            <n-form-item label="API地址">
              <n-input v-model:value="settings.api_base_url" />
            </n-form-item>
      ...
      <n-tab-pane name="notifications" tab="通知">
        <n-card title="通知设置">
          <n-space vertical>
            ...
            <n-button type="primary" style="margin-top: 16px" @click="saveSettings">保存</n-button>
          </n-space>
        </n-card>
      </n-tab-pane>
      ...
      <n-tab-pane name="help" tab="测试说明">
        ...
        <n-card title="Agent测试软件要求" style="margin-top: 16px">
          <n-space vertical>
...
import { NH1, NTabs, NTabPane, NCard, NForm, NFormItem, NInput, NInputNumber, NButton, NCheckbox, NSpace, NDescriptions, NDescriptionsItem, NCollapse, NCollapseItem, NText, NAlert, NTag } from 'naive-ui'
